...
paleta2 <- colorBin("YlOrRd", domain = sf_activos_cantones_uf$activos, bins = bins)
paleta3 <- colorBin("YlOrRd", domain = sf_recupe_cantones_uf$recupe, bins = bins)
paleta4 <- colorBin("YlOrRd", domain = sf_fallecidos_cantones_uf$fallecidos, bins = bins)
...
leaflet(sf_cantones) %>% 
  ...
  addPolygons(fillColor = ~paleta2(sf_activos_cantones_uf), stroke=T, fillOpacity = 1,
              color="black", weight=0.2, opacity= 0.1,
              group = "Activos", 
              popup = paste(
                "Cantón: ", sf_cantones$canton, "<br>",
  ...
  addPolygons(fillColor = ~paleta3(sf_recupe_cantones_uf), stroke=T, fillOpacity = 1,
              color="black", weight=0.2, opacity= 0.1,
              group = "Recuperados", 
              popup = paste(
                "Cantón: ", sf_cantones$canton, "<br>",
  ...
  addPolygons(fillColor = ~paleta4(sf_fallecidos_cantones_uf), stroke=T, fillOpacity = 1,
              color="black", weight=0.2, opacity= 0.1,
              group = "Fallecidos", 
              popup = paste(
                "Cantón: ", sf_cantones$canton, "<br>",
                "Recuperados: ", sf_fallecidos_cantones_uf$fallecidos,
                ))%>%
  ...
  addLayersControl(
    ...
    overlayGroups = c("Cantones", "Positivos", "Activos", "Recuperados", "Fallecidos"),
